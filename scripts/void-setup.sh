...
apply_gs org.gnome.desktop.interface font-name 'Iosevka 12'
apply_gs org.gnome.desktop.interface monospace-font-name 'Iosevka Nerd Font 12'
apply_gs org.gnome.desktop.interface document-font-name 'Iosevka 12'
apply_gs org.gnome.desktop.wm.preferences titlebar-font 'Iosevka Bold 12'
